## **Nemantix Source Available License Agreement**
...
* **Agreement:** this Nemantix Source Available License Agreement.
...
* **Licensor:** the entity offering these terms, which includes Kebula srl on behalf of itself and its subsidiaries and affiliates worldwide.
...
* **Nemantix:** the Nemantix software as provided by Kebula srl.
* **Software:** the Nemantix software and certain Software components designed to work with Nemantix and provided to You under this Agreement.
...
**Artificial Intelligence and Machine Learning Restriction**

You may not input, upload, use, or otherwise provide the Software, Modified versions, or any portion thereof, to any Large Language Model (LLM), Generative Artificial Intelligence (AI) system, Machine Learning (ML) model, or similar technology, whether for the purpose of prompting, training, fine-tuning, or inference.

Notwithstanding the foregoing, You are permitted to input the Software into such systems strictly for the following limited purposes:

1. **Academic and Non-Commercial Research:** Use within a recognized academic institution solely for non-commercial research, provided that the system or model being used does not retain the Software as part of its permanent training dataset or public outputs.
2. **Official Contributions:** Developing Modifications or debugging the Software for the sole and express purpose of contributing those Modifications back to the Licensor's official public repository.
...
The Agreement will be construed and enforced in all respects in accordance with the laws of the Republic of Italy, without reference to its choice of law rules. The competent courts located in Italy have exclusive jurisdiction for all purposes relating to this Agreement.
